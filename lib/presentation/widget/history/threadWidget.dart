                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            BaseOutlineButton(onPressedFunc: () {}, text: '스레드 추가하기', fontSize: 16, textColor: const Color(0xffffffff), backgroundColor: const Color(0xff000000), borderColor: const Color(0xff000000))
                          ]
                        ),
