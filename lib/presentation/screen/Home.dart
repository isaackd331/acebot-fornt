    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: BaseAppBar(
              ...
              actions: [
                IconButton(
                    onPressed: () {},
                    icon:
                        Image.asset('assets/icons/icons_newchat_disabled.png'),
                    iconSize: 18,
            ...
            body: SingleChildScrollView(
                ...
                child: BlocListener<SelfCubit, SelfState>(
                    listener: (context, state) {},
                    child:
                        BlocBuilder<SelfCubit, SelfState>(builder: (_, state) {
